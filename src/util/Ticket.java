...
public class Ticket {
    ...
    public void ImprimirDocumento() throws UnsupportedEncodingException  {//se coloca UnsupportedEncodingException para que imprima la ñ y vocales con acento
        String cadena = "";
        ...
        PrintService printers = PrintServiceLookup.lookupDefaultPrintService();
        PrintService service = (PrintService) printers;
        DocPrintJob pj = service.createPrintJob();
        byte[] bytes = cadena.getBytes("858");
