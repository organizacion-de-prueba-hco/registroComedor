...
public class daoAlmuerzo {
    ...
    public String sql_insert="INSERT INTO almuerzos (`comedor_id`, `expediente_id`, `created_at`) values(?,?,?);";
    ...
    "inner join facultads f inner join almuerzos d inner join  comedors c on s.user_id=u.id and d.comedor_id=c.id " +
    ...
    public boolean Guardar(Almuerzo c) {
   ...
   public boolean Editar(Almuerzo c,Object key) {
     PreparedStatement ps;
        try {            
            ps=cn.getCon().prepareStatement(sql_insert);
    ...
    public List<Almuerzo> Mostrar() {
      List<Almuerzo> listar=new ArrayList<>();
        try {            
            Almuerzo d;ResultSet r;
    ...
    public List<Almuerzo> Filtrar(Object c) {
     List<Almuerzo> listar=new ArrayList<>();
        try {            
            Almuerzo cli;ResultSet r;//codper, dni, nom, ape, sex, dir, tel, ruc
